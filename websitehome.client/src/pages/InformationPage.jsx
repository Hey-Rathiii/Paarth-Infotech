        ...
        <main className="information-page" id="main-content" tabIndex={-1}>
            <div className="information-shell"><span className="information-eyebrow">{privacy ? "Website privacy" : "Working with Paarth"}</span><h1>{title}</h1>
                ...
                {privacy ? <>
                    ...
                    <section><h2>Browser preferences and external services</h2><p>The website saves your light or dark theme preference in your browser’s local storage. The forms do not save your entries to local storage. Your browser may independently offer autofill.</p><p>We use Vercel Web Analytics to understand page visits and basic browser and device statistics. Read <a href="https://vercel.com/docs/analytics/privacy-policy" target="_blank" rel="noopener noreferrer">Vercel’s analytics privacy documentation</a> for details about the data it processes.</p><p>The website requests fonts from Google Fonts. Hosting and font services receive the connection information needed to deliver their resources, such as an IP address. Links to external profiles, websites or maps take you to services with their own privacy practices.</p></section>
                </> : <>
