    ...
    useEffect(() => {
        ...
        class App {
            constructor(container, options = {}) {
                ...
                if (!context) {
                    console.error('WebGL not supported or context unavailable');
                    this.disposed = true;
                    return;
                }
            ...
            initPasses() {
                ...
                if (!this.renderer || this.disposed) {
                    console.warn('Cannot initialize passes - renderer not ready');
                    return;
                }

                const context = this.renderer.getContext();
                if (!context) {
                    console.error('WebGL context not available for passes');
                    return;
                }
